...
> Visão visual do [sistema operacional do trio humano](../operating-model.md) e do [modelo operacional 90/10](operating-model-90-10.md) · referência anterior: [ciclo macro](../archive/original-vision.md) · [Fluxos separados por fase](journey-by-phase.md) · [workflows multiagente](../workflows/README.md).
