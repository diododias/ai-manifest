...
> Desdobramento prático de [Agent Team — sistema operacional do trio humano](../operating-model.md) · referência anterior: [visão macro](../archive/original-vision.md) · [Fluxo visual completo](end-to-end-journey.md) · [Fluxos por fase](journey-by-phase.md) · [workflows multiagente](../workflows/README.md).
