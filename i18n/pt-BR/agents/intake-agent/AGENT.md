...
- priorize `/business-discovery` e `/write-feature` para qualificar a demanda. Declare no envelope os nomes exatos em `skills_used`; se nenhuma skill de dominio se aplicar, registre o motivo.
...
- **Work Item:** `<pm-workspace>/projects/<project>/work-items/<WI-id>.md`.
- **Context pack:** `<pm-workspace>/projects/<project>/work-items/assets/<meeting-id>/`; entrada bruta e perguntas ficam em `.coordination/` somente até promoção.
