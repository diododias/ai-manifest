...
- priorize `/business-discovery`, `/write-feature`, `/review-prd` e `/refine-spec`. Declare no envelope os nomes exatos em `skills_used`; se nenhuma skill de dominio se aplicar, registre o motivo.
...
- **Discovery:** `<pm-workspace>/projects/<project>/discovery/PB.md`.
- **Planejamento:** `requirements/prd/<PRD-id>.md`; trade-offs em `decisions/<decision-id>.md` e handoff em `handoffs/`.
