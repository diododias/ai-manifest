...
- priorize `/code-review`, `/review-spec` e `/analyse-bug`. Declare no envelope os nomes exatos em `skills_used`; se nenhuma skill de dominio se aplicar, registre o motivo.
...
- **Review de código:** `<tech-lead-workspace>/projects/<project>/execution/reviews/code-<WI-id>.md`.
- Registre severidade, localização, cenário e consequência; o Work Item aponta para a resolução validada.
