...
- priorize `/review-prd`, `/review-cross-prd-spec` e `/refine-spec`. Declare no envelope os nomes exatos em `skills_used`; se nenhuma skill de dominio se aplicar, registre o motivo.
...
- **Discovery:** `<pm-workspace>/projects/<project>/discovery/reviews/<review-id>.md`; **planejamento:** `requirements/reviews/<review-id>.md`.
- Não altere `PB.md` ou `PRD.md` do autor; persista finding, evidência e recomendação de gate.
