...
- priorize `/review-spec`, `/code-review` e `/technical-discovery`. Declare no envelope os nomes exatos em `skills_used`; se nenhuma skill de dominio se aplicar, registre o motivo.
...
- **Review de arquitetura:** `<tech-lead-workspace>/projects/<project>/execution/reviews/architecture-<WI-id>.md`.
- Exceções apontam para ADR ou decisão formal; não altere código ou SPEC do autor.
