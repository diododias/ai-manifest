...
- priorize `/technical-discovery`, `/analyse-bug` e `/review-spec`. Declare no envelope os nomes exatos em `skills_used`; se nenhuma skill de dominio se aplicar, registre o motivo.
...
- **Parecer especializado:** `<tech-lead-workspace>/projects/<project>/execution/reviews/<dominio>-<SPEC-ou-WI-id>.md`.
- Controles aceitos são promovidos pelo owner para `engineering/specs/` ou `engineering/adr/`.
