...
**Vizinhos:** [sistema operacional do trio humano](../operating-model.md) · [pacotes importáveis](README.md) · [Meeting Context Agent — contrato executável](meeting-context-agent.md).
