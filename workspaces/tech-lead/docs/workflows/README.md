...
| [Release e observação](../../../../docs/workflows/08-production-release-and-observation.md) | rollout, saúde e rollback | `projects/<project>/execution/evidence/` e `LEARNINGS.md` (candidatos) |
| [Conhecimento e melhoria](../../../../docs/workflows/10-continuous-improvement.md) | consolida telemetria e propostas | `projects/<project>/LEARNINGS.md` |
