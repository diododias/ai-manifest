...
|---|---|---|
| [Discovery](../../../../docs/workflows/01-discovery-and-research.md) | pesquisa, jornada e hipótese de experiência | `projects/<project>/research/` e `journeys/` |
| [Produto e UX](../../../../docs/workflows/02-product-and-ux-planning.md) | fluxos, estados, acessibilidade e UX spec | `projects/<project>/flows/`, `specifications/`, `prototypes/` e `validation/` |
| [Validação](../../../../docs/workflows/05-adversarial-validation.md) | evidencia critérios de UX quando acionado | `projects/<project>/validation/` |
